# Contributing to ar-timestamptz
...
mailing lists is expected to follow the [code of conduct](https://github.com/fnando/ar-timestamptz/blob/main/CODE_OF_CONDUCT.md).
...
by [opening an issue on Github](https://github.com/fnando/ar-timestamptz/issues).

When you're ready to make your pull request, follow checklist below to make sure
your contribution is according to how this project works.

1. [Fork](https://help.github.com/forking/) ar-timestamptz
