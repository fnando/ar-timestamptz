...
require_relative "./lib/ar/timestamptz/version"
...
Gem::Specification.new do |spec|
  ...
  spec.summary     = "Make ActiveRecord's PostgreSQL adapter use timestamptz " \
                     "as datetime columns."
  spec.description = spec.summary
  spec.license     = "MIT"
  spec.required_ruby_version = Gem::Requirement.new(">= 2.6.0")

  github_url = "https://github.com/fnando/ar-timestamptz"
